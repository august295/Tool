...
#define AAC_FILE_NAME    "../../resources/SampleVideo_1280x720_30mb.aac"
...
static int rtpSendAACFrame(int socket, const char* ip, int16_t port, struct RtpPacket* rtpPacket, uint8_t* frame, uint32_t frameSize)
{
